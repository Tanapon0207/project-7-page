    ...
    <div class="login-page col-sm-3 container">
        <form>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="Password1" placeholder="รหัสผ่าน" required maxlength="16">
            </div>
            ...
            <a class="btn btn-primary" href="หน้าหลักหลังลงทะเบียนเสร็จเเล้ว.html" role="button">เข้าสู่ระบบ</a>
        </form>
